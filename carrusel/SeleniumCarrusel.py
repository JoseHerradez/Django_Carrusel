...
class Seleniumtests(unittest.TestCase):
    ...
    def test_seleniumtests(self):
        ...
        driver.find_element_by_id("id_title").send_keys("titulo")
        ...
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("titulo1")
        ...
        driver.find_element_by_id("id_1-title").send_keys("titulo2")
